...
var fetchControl = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, controls_1.getControls('0010', '0100', req.params.menuParams)];
            case 1:
                data = _a.sent();
                if (!data) return [3 /*break*/, 4];
                return [4 /*yield*/, (data === null || data === void 0 ? void 0 : data.map(function (dt) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, controls_1.getSubControls(dt.ControlSQL, placeholders)];
                                case 1:
                                    records = _a.sent();
                                    if (records) {
